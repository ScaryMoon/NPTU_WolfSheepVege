...
def HumanGoR():  # 單 人右邊
    ...
    canvas.move(2, 1, 0)
    canvas.delete(2)
    canvas.create_image(900, 530, anchor=NW, image=humancanR)  # pic 2
    canvas.delete(2)
    win.update()
...
def HuSheepR():  # 人羊 右
    ...
    canvas.create_image(900, 530, anchor=NW, image=humancanR)  # 到對岸的人
...
def HuSheepL():  # 人羊 左
    ...
    canvas.create_image(350, 530, anchor=NW, image=humancan)  # 到對岸的人
...
wolfcan = PhotoImage(file="Rwolf.png")
